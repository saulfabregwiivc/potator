...
struct retro_core_option_definition option_defs_us[] = {
   ...
   },
   {
      "potator_mix_frames",
      "Interframe Blending",
      "Simulates LCD ghosting. 'Simple' performs a 50:50 blend of the current and previous frames. 'LCD Ghosting' accumulates pixels from multiple successive frames. Can help to alleviate the flickering that is common in Supervision games",
      {
         { "disabled",  NULL },
         { "mix",       "Simple" },
         { "lcd_ghost", "LCD Ghosting" },
         { NULL, NULL },
      },
      "disabled"
   },
   {
      "potator_lcd_persistence",
      "LCD Persistence",
      "Specifies the magnitude of the effect when 'Interframe Blending' is set to 'LCD Ghosting'.",
      {
         { "0.25", "25%" },
         { "0.30", "30%" },
         { "0.35", "35%" },
